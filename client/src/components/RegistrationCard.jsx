  ...
  return (
    <div className="max-w-md rounded-2xl overflow-hidden shadow-lg bg-[#2A2A2A] text-[#F5F5F5] p-6 hover:shadow-2xl transition-shadow duration-300">
      <img
        ...
        src={data.img_path || 'assets/img/eventDefault.webp'}
        alt={data.title}
      />
      <div className="mt-4 flex flex-col gap-2">
        <h2 className="text-2xl font-bold text-[#06B6D4]">{data.title}</h2>
        ...
        <button
          className="mt-4 bg-[#06B6D4] hover:bg-[#0891B2] text-[#1A1A1A] font-bold py-2 px-4 rounded-md transition-colors duration-200 disabled:opacity-50"
